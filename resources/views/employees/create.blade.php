                    ...
                    <form method="POST" action="{{ route('employees.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="role" name="role" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                @foreach($allowedRolesForCreation as $role)
                        ...
                        <div class="mb-4">
                            ...
                            <select id="pendidikan_terakhir" name="pendidikan_terakhir" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="SMA Sederajat" @selected(old('pendidikan_terakhir') == 'SMA Sederajat')>SMA Sederajat</option>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nomor_telepon" class="block mt-1 w-full" type="text" name="nomor_telepon" :value="old('nomor_telepon')" autocomplete="tel" />
