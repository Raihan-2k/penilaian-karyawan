                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('tasks.update', $task) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" rows="5" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('description', $task->description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="assigned_to_employee_id" name="assigned_to_employee_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}" @selected(old('assigned_to_employee_id', $task->assigned_to_employee_id) == $employee->id)>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="deadline" class="block mt-1 w-full" type="date" name="deadline" :value="old('deadline', $task->deadline?->format('Y-m-d'))" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="status" name="status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="submitted" @selected(old('status', $task->status) == 'submitted')>Submitted</option>
